...
const WORKBOOK_REGION_SYSTEM = [
  ...
  "deterministicCandidate contains the complete selected-column catalog; inspection contains only a bounded cell sample.",
  "Do not drop fields absent from inspection or repeat deterministicCandidate fields unless correcting them; use fieldPatches for changed columns only.",
