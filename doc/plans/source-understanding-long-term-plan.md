...
Status: reference
Read when: designing long-term source-aware workbook/document understanding beyond the current slice.
Last reviewed: 2026-06-25

Created: 2026-06-18  
Scope: source-aware workbook/document understanding, source retrieval, extraction proposals, and chart proposals  
Related docs: `doc/arch/architecture.md`, `doc/plans/roadmap.md`, `doc/plan.md`, `doc/contracts/saas-api-contract-v0.md`, `doc/contracts/saas-database-schema-v0.md`, `doc/contracts/backend-api-contract.md`, `doc/contracts/canonical-data-dictionary.md`, `doc/arch/ai-boundaries.md`
...
- Add source document, source region, and source extract proposal docs to `doc/contracts/saas-api-contract-v0.md`.
- Add schema draft to `doc/contracts/saas-database-schema-v0.md`.
- Add C-number distribution to `doc/contracts/canonical-data-dictionary.md`.
