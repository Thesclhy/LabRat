  ...
  return (
    <section className="blank-onboarding" aria-label="Blank project onboarding">
      <div className="blank-onboarding-head">
        ...
        <button className="primary" type="button" onClick={onImportWorkbook}>Import Excel workbook</button>
      </div>
      ...
      <div className="blank-template-panel">
        ...
        <p>Use these files as formatting references, then upload your own workbook through Import Excel workbook.</p>
